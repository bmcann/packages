...
%{__chmod} +x %{buildroot}%{python3_sitelib}/twisted/trial/test/scripttest.py
%endif
...
%if 0%{?with_python3}
%{__rm} -v %{buildroot}%{python3_sitelib}/twisted/runner/portmap.c
%{__rm} -v %{buildroot}%{python3_sitelib}/twisted/test/raiser.c
%{__rm} -v %{buildroot}%{python3_sitelib}/twisted/internet/iocpreactor/iocpsupport/winsock_pointers.c
%{__rm} -v %{buildroot}%{python3_sitelib}/twisted/internet/iocpreactor/iocpsupport/winsock_pointers.h
%{__rm} -v %{buildroot}%{python3_sitelib}/twisted/internet/iocpreactor/iocpsupport/iocpsupport.c
%{__rm} -v %{buildroot}%{python3_sitelib}/twisted/python/_sendmsg.c
%endif
